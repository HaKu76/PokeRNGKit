...
1. PokeFinder 4.3.2 产品模块、3DSRNGTool Gen VII、Gen VI Stationary / Pokemon Link / Event / Wild / DexNav / Poke Radar 与公共 Profile Manager 已实现。
2. 下一模块为 3DSRNGTool Gen VI Egg RNG；字段、控件边界和算法以对应 WinForms/Core 源码为准。
