...
- 上游版本：4.3.2
- 本地核验来源：`C:\Users\Hakuhiro\Desktop\project\PokeFinder-master`
- 导入日期：2026-08-11
- 许可证：GNU GPL v3 or later
- 导入范围：第三世代 ID Generator 与 GameCube Generator/Searcher 所需的 Core、共享 LCRNG、状态与筛选父类，以及第五世代 IV Cache Finder 所需的 MT、Jump 表与 RNGList；Gen VIII ID 使用模块内逐字复制的 IDGenerator8 与 Xorshift，并复用共享 IDFilter/IDState8；G3 Static、Wild、IVs to PID、PID to IVs、PokeSpot、Jirachi、Egg、G4 Static、G4 Wild、Gen V Hidden Grotto、Gen VIII Event、Gen VIII Raids、Gen VIII Static、Gen VIII Underground 与 Gen VIII Wild 以独立 bridge 对照上游源码实现；Encounter Lookup 以静态生成数据对照上游行为
...
PokeFinder Manager 没有导入、导出或清空按钮；PokeRNGKit 通过独立 schema 提供这些本地备份能力，不直接导入或覆盖桌面端整份 `profiles.json`。ProfileDisplay8 的 SwSh/BDSP 临时默认版本判断与过滤方向相反，Web 端按正确版本组提供默认记录，不复制该上游缺陷。

## Gen VIII Event 只读核验

`gen8event` 对照本地 PokeFinder 4.3.2 归档的 Event Form、Generator、状态、筛选、模型、翻译与固定夹具实现独立 C++/Wasm bridge。上游源码不作为运行时构建依赖；完整输入边界、`.wb8` 字段、PID Type 缺陷修正、结果契约和固定夹具见 `docs/modules/gen8event.md`。

```text
003FC1D80A6241732E6B39A080E671CEA1A8C5A280275CBC751ADAA9C6E8CD34  Form/Gen8/Event8.cpp
12BEF202DC3104B5ED0E2CDCB53836B3DCDB5CEF7F3E87ACED9493F4CC4FF690  Form/Gen8/Event8.hpp
AB1CFEFE4FC9C8E15AB67544DD8FE69E74B5AE10BC328C3E51E79342F227D313  Form/Gen8/Event8.ui
B10284E8245612FE6BFF751F84099D8B627DA8A11E5DF5D25F51119832841272  Form/Controls/Filter.cpp
59B2324853073D9479DAD8EDFF344AB0F35D2FA64A6EEF942D933B428C289391  Form/Controls/Filter.hpp
4A25CAE5DDDD2D3DA1AAED925BAC1D302ED1CB7DE9C1B3A0B31E7B662CD3F777  Form/Controls/Filter.ui
51B4F88667748825CE5091600BD2C5EE7F0152912BFC25856004319E41863FCA  Form/Controls/TextBox.cpp
F216F3D15168487B037F0BDC478F3265179B4297B0F0B70A370ED412AEB9AAF2  Form/Controls/TextBox.hpp
B98EF832E6CA35FD65C0A78F00F38ED08055D22156DF68C89197C1D40DCB35FC  Core/Gen8/Generators/EventGenerator8.cpp
C49ED699A8DA1C1B14169D189B0E94C18F5D309D6687C15A1BE173C66581BECE  Core/Gen8/Generators/EventGenerator8.hpp
8E98FFCAC0B797775841B99AE9DDAC3475431BFE67AD87544E3CB1D4E049973D  Core/Gen8/States/State8.hpp
68A064B46EAB68747BB611FA1523EA217C9603DF2A97047F45C834D6E91C00FF  Core/Gen8/WB8.hpp
7ECD8D57A714520497096F1D69B5B0C68672E87EE7F1D46AD00DCD9DD4C72C71  Core/Gen8/Profile8.hpp
49C0716A1928238D831CFFA2BFE5A4BDFB7E97141BA1D0AF47B36463AEBE37D1  Core/Parents/Filters/StateFilter.cpp
902F0ECFF4D57889276280651D35F560D87008237936131D07A090E45BFB1C8C  Core/Parents/Filters/StateFilter.hpp
4AD6C34E7F55EC1863171DF3D9D865A9C22969D4DB74341B5D7B455491E292EB  Core/Parents/States/State.cpp
A5A5A47DFE175EA915E6DB5DE026638297100752F9DBFAA52287713E3F33CD72  Core/Parents/States/State.hpp
DE999DE807EF88258B2A404CB74E7B99FBECCD4EC9F55CDD003643AAB4B4E918  Core/RNG/RNGList.hpp
0E82B3139772E837743D8866A85596D14FEB982FB212FD2C2BE59F201F33146F  Core/RNG/Xorshift.cpp
2E7C77D50050C630EFD3361BE489E3D934028D8C7282EE9FDCFEFB2C2F238818  Core/RNG/Xorshift.hpp
81E881F92987CA7D8E51E5E9F1EDC639D8B69B4A6D6955ABDD2FCC9DD6B3C8D0  Core/Util/Nature.cpp
4CD05C3C9380FD38C948F500C1833B2C532A37E704FAF4879CAA07734DD66B42  Core/Util/Nature.hpp
2DA3496DB43264D42569FB97A70E82E9AB3B1D52008582316C44857042F97458  Core/Util/Utilities.hpp
25F0A57EB95738AD42DC0903A6F23461CB3944073C094D00A3242FD58F8BAEF1  Model/Gen8/StaticModel8.cpp
1195ECD20B11CBF11C31A261F25BE6B055A1E1D56220DCB4716FCFA3DB442FB6  Model/Gen8/StaticModel8.hpp
FBE244DB70B3A5EE53D393E281155ABB4C497F753C5BE5659BE0BE57FB847A16  Form/i18n/PokeFinder_zh.ts
0240480C53907CBB137A0BC73D7531026DDD044C077FA1730DE08004AE17E305  Form/i18n/PokeFinder_ja.ts
51BC9A750A7A2CA4984065D7E56412EDB93AF6274AD563DF5098ACC693580235  Test/Gen8/EventGenerator8Test.cpp
325300A750E16908F6DA8C326BD297E9879B5A024E0689769CCF0DD8D01C4F46  Test/Gen8/EventGenerator8Test.hpp
915574C92F9273AA3D781670606D5500D7179E3F1BCEA5FC070BDFD04D9EA4BF  Test/Gen8/event8.json
```

## Gen VIII Raids 只读核验

`gen8raids` 对照本地 PokeFinder 4.3.2 归档的 Raids Form、Generator、巢穴结构、状态、筛选、结果模型、翻译与固定夹具实现独立 C++/Wasm bridge。上游源码不作为运行时构建依赖；`scripts/generate_gen8_raids_data.mjs` 将 EncounterTableGenerator revision `7769c1df80be93761fe6479d51cbf2fe7a7dc4f9` 的 197 张 `nests.json` 巢穴表、69 张 Event 表，与 PokeFinder 的 276 个 Den 映射和 1192 条个人数据记录生成到 TypeScript/C++ 静态数据。完整输入边界、41/12-word 契约、生成方式和验证状态见 `docs/modules/gen8raids.md`。

```text
E8F1E833F96FD2B169CE354954757E196854AD5503DAEA0CBA95E107545D4999  Form/Gen8/Raids.cpp
2DA3496DB43264D42569FB97A70E82E9AB3B1D52008582316C44857042F97458  Core/Util/Utilities.hpp
A1D7FBEE6A2C729D5BD9E26241C76CF12F961AA0468D060894D225E59AE7A8AC  Core/Resources/Personal/Gen8/personal_swsh.bin
25F0A57EB95738AD42DC0903A6F23461CB3944073C094D00A3242FD58F8BAEF1  Model/Gen8/StaticModel8.cpp
1195ECD20B11CBF11C31A261F25BE6B055A1E1D56220DCB4716FCFA3DB442FB6  Model/Gen8/StaticModel8.hpp
FBE244DB70B3A5EE53D393E281155ABB4C497F753C5BE5659BE0BE57FB847A16  Form/i18n/PokeFinder_zh.ts
0240480C53907CBB137A0BC73D7531026DDD044C077FA1730DE08004AE17E305  Form/i18n/PokeFinder_ja.ts
D5FFC3DD62DAC6D8BE92150D6CE314FA4003DD913038E8EB698BD416C0D8C827  Test/Gen8/RaidGeneratorTest.cpp
3A605F3CA558EEB82B94FED1C0973D37852D57C833C4EB6BF12270EA97F011A4  Test/Gen8/RaidGeneratorTest.hpp
D0E5C4C78D9EE658A42E37E9267A19FBD20078CF8F5EDB246E9768A4078A3EDA  Test/Gen8/raid.json
```

EncounterTableGenerator 数据核验：

```text
36F18FD010F32DF50CDFA48DC76A6976C2E1DE7ACFD1A6CF8E664F49FEE95AB4  Gen8/swsh/nests.json
59F5953794AC4A4D50B2000CD77CE7019F1E5B8D427742C40044BCE0B54A4477  Gen8/swsh/event1.json
398E3911BBEE43C97F93F9E95A3CD4168583503A924D7717CA94F40168338B83  Gen8/swsh/event69.json
B6BB4E163E093C35CC2F6A10E403B6D8D824E3E53B76771661B36C006CFE3E62  event1.json..event69.json SHA-256 清单
```

事件清单按数值顺序记录 69 行“文件 SHA-256 + 两个空格 + 文件名 + LF”，总源文件大小为 6,712,827 bytes。生成结果 `src/features/gen8raids/data.ts` 的 SHA-256 为 `4FFF1726D8F3B381038703DCCB78BF1E159C115EB45EBC61668A31FF34417E8E`，`wasm/modules/gen8raids/bridge/raid_data.inc` 的 SHA-256 为 `54C912E48C35C3D112D0517C26263580B6B6A3BB83951972D1C5239FD95A3992`。

## Gen VIII Static 只读核验

`gen8static` 对照本地 PokeFinder 4.3.2 的 Static8 Form、Generator、模板、筛选、状态、结果模型、翻译和固定夹具实现独立 C++/Wasm bridge。上游源码不作为运行时构建依赖；PokeFinder 该模块仅有 BDSP Generator，没有 Searcher。完整输入边界、9 类 47 个模板、41/11-word 契约、普通/游走分支和固定夹具见 `docs/modules/gen8static.md`。

```text
FCA4A12B76C8A68D8DA30F4FA191D05A9033799E913030843A4A0934205BBD7C  Form/Gen8/Static8.cpp
62FEAA4BF22714F76BB4EBE25B704542224F827DB5F1767CC15AB58448848FE1  Form/Gen8/Static8.hpp
FAD0FAFCF6214EB22F6E6FB2467FB7F47DB8DB92D0F3F2F887190F75B7B3B3DE  Form/Gen8/Static8.ui
```

EncounterTableGenerator revision `7769c1df80be93761fe6479d51cbf2fe7a7dc4f9` 的 `Gen8/encounters.json` 为 8,761 bytes，SHA-256 为 `493D8A4CAFA0A57FC0C729E808333647C30EEF84085B75F427F23D1823D2284D`。生成结果 `src/features/gen8static/data.ts` 的 SHA-256 为 `1BFEB694B277D306503F03BA171E5C609AD0A3D8998C0B805206B70ADAA68BF7`，`wasm/modules/gen8static/bridge/personal_data.inc` 的 SHA-256 为 `C662136D3341F38D5BEF0E182DD29D85DF1A3CE7C0379D0C55F98E748FCC2393`。

## Gen VIII Underground 只读核验

`gen8underground` 对照本地 PokeFinder 4.3.2 的 Underground Form、Generator、Area、Filter、State、Model、翻译和固定夹具实现独立 C++/Wasm bridge。上游源码不作为运行时构建依赖；PokeFinder 该模块仅有 BDSP Generator，没有 Searcher。完整输入边界、54/12-word 契约、数据生成和固定夹具见 `docs/modules/gen8underground.md`。

```text
BCB4BC736EE6DBE78FB799B2A032EFA9DF1EBDDC8722EDA41FFB6C55A8D9A4D6  Form/Gen8/Underground.cpp
583AD90E2EEAACD8BD016A232377638F2053F0D93A352FB835F7EA588B513F04  Form/Gen8/Underground.hpp
FFD2EE9893B24FA9664CE80BA7ECEF603C9F7F21C060133A926C5147F20F8E96  Form/Gen8/Underground.ui
B10284E8245612FE6BFF751F84099D8B627DA8A11E5DF5D25F51119832841272  Form/Controls/Filter.cpp
59B2324853073D9479DAD8EDFF344AB0F35D2FA64A6EEF942D933B428C289391  Form/Controls/Filter.hpp
4A25CAE5DDDD2D3DA1AAED925BAC1D302ED1CB7DE9C1B3A0B31E7B662CD3F777  Form/Controls/Filter.ui
C1F3065F51D05D53457D2D71E886101695783304EA1332E3BC0AEF667EA43C91  Form/Controls/CheckList.cpp
C0A43180BA5A0BBB0823CA66FC8FE2B6B684246ABE191166342ED2F9D35E415C  Form/Controls/CheckList.hpp
51B4F88667748825CE5091600BD2C5EE7F0152912BFC25856004319E41863FCA  Form/Controls/TextBox.cpp
F216F3D15168487B037F0BDC478F3265179B4297B0F0B70A370ED412AEB9AAF2  Form/Controls/TextBox.hpp
22E88A2A325940AABDE8929207FCD90296955247E8D1C07CA7FD480C152342B1  Core/Enum/Lead.hpp
5E77BC4910859F473FF6714EA426A82F75533028A75F422AEDF93FDD2E8EF046  Core/Gen8/Encounters8.cpp
9F4842DD429404491DD98FE65D1F477B34DDF893BBA71117703F3CEFB56644B8  Core/Gen8/Encounters8.hpp
37FFE6D6092D8A91DE804C64478C396E76F9D6B15213F24E0804F9A4CA7FEEA0  Core/Gen8/UndergroundArea.cpp
9E06C3A734B5853219DF0E53611F7057B4BA89BE99F96E0AF00FDBDD4E83C6ED  Core/Gen8/UndergroundArea.hpp
C21E487B41090C04F35982FCE0F078A09C140279009B2BC4083A9A80A9D53F1D  Core/Gen8/Generators/UndergroundGenerator.cpp
E9D471D3E1FE0C31B2585C2200972461BB8F7785A839D44A61BFC587EC84E843  Core/Gen8/Generators/UndergroundGenerator.hpp
2321C698BC5E01E73B800D6D320DAC755989B56F469030F4D17ED4B78B41D4F9  Core/Gen8/Filters/UndergroundFilter.cpp
DE6BD20E8DB4B0022AE71925B4AD3702551CCB2EB8C1AD7F0055E0607564C4A2  Core/Gen8/Filters/UndergroundFilter.hpp
9C51959DA415B3AA3B5104AF5B40586F15A6424A8F25EAE3FA2755E8869A654E  Core/Gen8/States/UndergroundState.hpp
76080D8D317F0DC7C544BCD5C0B044E3DEBE4D7881A8D2DD889ABD6F95FEC2EE  Model/Gen8/UndergroundModel.cpp
765F2F7003778F58462513D81F826CFEFC15066B744498AC2E92DD87BFDE7AE7  Model/Gen8/UndergroundModel.hpp
FBE244DB70B3A5EE53D393E281155ABB4C497F753C5BE5659BE0BE57FB847A16  Form/i18n/PokeFinder_zh.ts
0240480C53907CBB137A0BC73D7531026DDD044C077FA1730DE08004AE17E305  Form/i18n/PokeFinder_ja.ts
218F53349241FFEF938731CE6A814EFCB9C7022B35A2C03ED7E2D62F5ED4FF8A  Test/Gen8/UndergroundGeneratorTest.cpp
618AAA67A72F47FFACCFFCFB38F95FBDD114C8C9B7F15F163B941761ABC9C0F0  Test/Gen8/UndergroundGeneratorTest.hpp
9AE3C907EAEBCEC6C88D33EF41FFB98AC60EB89EE8F0A41EDA1ECDF43187A959  Test/Gen8/underground.json
```

EncounterTableGenerator revision `7769c1df80be93761fe6479d51cbf2fe7a7dc4f9` 的 `UgPokemonData.json` 为 251,287 bytes，SHA-256 `35BCE0E747D8AC530F76BF148383A655AC538190A1E15123441F5A91E493739B`；`UgRandMark.json` 为 9,126 bytes，SHA-256 `9C633DEEDABC315EFDAD995A15935086FDEE75F69A80B4A2291BE3243B56CC1C`；`UgSpecialPokemon.json` 为 9,585 bytes，SHA-256 `175941C41DB9372F967991EF063C2771D05EDAC67F495AE052390F5F745A79A1`。生成结果 `src/features/gen8underground/data.ts` 的 SHA-256 为 `C955AF5997E7F7B892A59F2AF930C88093B22BA59D022D0A69D1702953299656`，`wasm/modules/gen8underground/bridge/underground_data.inc` 的 SHA-256 为 `DC27D1723D7ADB9B83C89F1120EDF15F66622337CFF5324E1A2E866D60EBD40C`。

## Gen VIII Wild 只读核验

`gen8wild` 对照本地 PokeFinder 4.3.2 的 Wild8 Form、WildGenerator8、EncounterArea8、Encounters8、WildState8、StateFilter、WildModel8、翻译和 `wild8.json` 固定夹具实现独立 C++/Wasm bridge。上游源码不作为运行时构建依赖；PokeFinder 该模块只有 BDSP Generator，没有 Searcher。完整输入边界、48/12-word 契约、数据生成、Nature 筛选补充和固定夹具见 `docs/modules/gen8wild.md`。

```text
34CCFBB3A3FACC863FA8C89C7DA91B74CCDCA319B20EF56BA53F2F3AD5298FA7  Form/Gen8/Wild8.cpp
23BE1C6C5AA02DB55816A7EB520E9ED9A13099EC728659186318855EE8322713  Form/Gen8/Wild8.hpp
4CF65606CE2CF83F162B6E73EB485389DCF6F0948E27AB744BB6ED05009E8031  Form/Gen8/Wild8.ui
D8D7105490865B24F07D70A7D7F418C902E2359A0FE46B1D810158CC083DA2BD  Core/Gen8/Generators/WildGenerator8.cpp
011A9549968C24500AE39AAA3EDB6DB237C5B50A9A7B2366122D51AC69D9DA83  Core/Gen8/Generators/WildGenerator8.hpp
1178F3879A3732C6BB04D2E79E61DD0BEC36F6D696F5F524F6B5D0737A25DE42  Core/Gen8/EncounterArea8.cpp
D6EDC58116B53F8FB8140CF7C21705A163A929F8C6CEF49CB0E13B5AD702C80F  Core/Gen8/EncounterArea8.hpp
5E77BC4910859F473FF6714EA426A82F75533028A75F422AEDF93FDD2E8EF046  Core/Gen8/Encounters8.cpp
9F4842DD429404491DD98FE65D1F477B34DDF893BBA71117703F3CEFB56644B8  Core/Gen8/Encounters8.hpp
49C0716A1928238D831CFFA2BFE5A4BDFB7E97141BA1D0AF47B36463AEBE37D1  Core/Parents/Filters/StateFilter.cpp
902F0ECFF4D57889276280651D35F560D87008237936131D07A090E45BFB1C8C  Core/Parents/Filters/StateFilter.hpp
4E5CBCB1FBE7FFE559EAD6555DC02878E0D9B8700CE185998B381CFBB4DB7EC3  Core/Resources/Personal/Gen8/personal_bdsp.bin
0423A228B2A0E959E308AA03A2E2C9DF11F0DE3793B784EC32C8D30EA8244B63  Test/Gen8/WildGenerator8Test.cpp
340FF43840382E7F42DEE7FA83A57656E0E64D9752C003F7E9AF1B30098DC566  Test/Gen8/wild8.json
```

EncounterTableGenerator revision `7769c1df80be93761fe6479d51cbf2fe7a7dc4f9` 的 `FieldEncountTable_d.json` 为 1,005,103 bytes，SHA-256 `B1B917F62AB4E5D0DEA592D41253B5B137255BDB4178AB1E467935A7475333D7`；`FieldEncountTable_p.json` 为 1,005,098 bytes，SHA-256 `ABC33ADE1D1C49851086070C5F81C97922F6616674BCE79909A17BA8DB03E049`；`MapInfo.json` 为 2,530,118 bytes，SHA-256 `311D0F7BB76D4DA2862F0BE3CE811FF1A4652E37CA8547EF324425C7E046EBED`；`english_dp_fld_areaname.json` 为 131,661 bytes，SHA-256 `30E1A753E577EC2E783077AA95F90BEEB1FFC99766BCB4A888F6E8EB43FD2CD4`；`location_modifier.json` 为 3,809 bytes，SHA-256 `E1D708DF084FC0E3AB76EA4BF8AE8BAFB2637207C2657522DA0A460B8F98FF3B`。生成结果 `src/features/gen8wild/data.ts` 的 SHA-256 为 `2F0053803BDF688EC080894879FB6990901787533FD9A4153249EFF6B5C8BE03`，`wasm/modules/gen8wild/bridge/wild_data.inc` 的 SHA-256 为 `985B95A53A6584802991954D6D4D4A4A590EBF4F30982A2233D1D98C2539BD7C`。
