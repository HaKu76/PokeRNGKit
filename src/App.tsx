    ...
    <div className="app-shell">
      ...
      <div className="workspace">
        <aside className="module-rail">
          ...
          <button className="module-entry active" type="button">
        ...
        <main className="main-content">
          <div className="page-heading">
            ...
            <div className="heading-version">{t("version")}</div>
          </div>
          {uiPreviewMode && (
          ...
          <form className="control-grid" onSubmit={generate}>
            <section className="panel input-panel">
              ...
              <div className="mode-tabs" role="tablist" aria-label={t("mode")}>
                {modes.map((entry) => (
                  <button
                    className={
                ...
                <div className="rs-inputs">
                  ...
                  {rsSource === "date" && !deadBattery ? (
                    <label className="field">
                      ...
                      <input
                        onChange={(event) => setRsDateTime(event.target.value)}
                        type="datetime-local"
                        value={rsDateTime}
                      />
                    </label>
